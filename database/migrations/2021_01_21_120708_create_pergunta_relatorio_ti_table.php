...
class CreatePerguntaRelatorioTiTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pergunta_relatorio_ti', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::table('pergunta_relatorio_ti', function($table){
    ...
    {
        Schema::dropIfExists('pergunta_relatorio_ti');
    }
}
